        ...
        <div className='flex-1'>
                    ...
                    {wishlistItems.length > 0 && (
                        <div className='flex flex-col sm:flex-row gap-4'>
                            ...
                            <button 
                                ...
                                className='flex items-center space-x-2 border-2 border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-white hover:text-purple-600 transition-colors duration-300'
                            >
            ...
            {wishlistItems.length === 0 ? (
                ...
                <div className='bg-white rounded-2xl shadow-lg p-12 text-center'>
                    <FontAwesomeIcon icon={faHeartBroken} className='text-6xl text-gray-300 mb-6' />
                    ...
                    {inStockItems.length > 0 && (
                        <div>
                            <div className='flex items-center justify-between mb-6'>
                                ...
                                <button 
                                    onClick={addAllToCart}
                                    className='flex items-center space-x-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white px-4 py-2 rounded-lg font-semibold hover:shadow-lg transition-all duration-300'
                                >
                                    <FontAwesomeIcon icon={faShoppingCart} />
                                    ...
                                    <div key={item.id} className='bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 group'>
                                        ...
                                        <div className='p-4'>
                                            ...
                                            <div className='flex space-x-2'>
                                                <button className='flex-1 bg-gradient-to-r from-purple-600 to-pink-600 text-white py-2 rounded-lg font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-2'>
                        ...
                        <div>
                            ...
                            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                                {outOfStockItems.map((item) => (
                                    <div key={item.id} className='bg-white rounded-2xl shadow-lg overflow-hidden opacity-75'>
                                        <div className='relative'>
                                            <img 
                                                src={item.image} 
                                                alt={item.name}
                                                className='w-full h-48 md:h-56 object-cover grayscale'
                                            />
                                            <div className='absolute top-3 left-3'>
                                        ...
                                        <div className='p-4'>
                                            ...
                                            <button className='w-full bg-gray-300 text-gray-500 py-2 rounded-lg font-semibold cursor-not-allowed'>
                    ...
                    <div className='bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-8'>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
                            <div className='bg-white rounded-lg p-4 text-center hover:shadow-md transition-shadow duration-200'>
                                ...
                                <h3 className='font-semibold text-gray-900 mb-2'>Similar Items</h3>
                                <p className='text-gray-600 text-sm'>Discover products similar to your wishlist</p>
                            </div>
                            <div className='bg-white rounded-lg p-4 text-center hover:shadow-md transition-shadow duration-200'>
                                ...
                                <h3 className='font-semibold text-gray-900 mb-2'>Popular Now</h3>
                                <p className='text-gray-600 text-sm'>See what other customers are loving</p>
                            </div>
                            <div className='bg-white rounded-lg p-4 text-center hover:shadow-md transition-shadow duration-200'>
                                <div className='bg-purple-100 w-12 h-12 rounded-lg flex items-center justify-center mx-auto mb-3'>
                                ...
                                <p className='text-gray-600 text-sm'>Continue browsing your recent items</p>
                            </div>
                        </div>
                    </div>
                </div>
